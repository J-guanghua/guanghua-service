...
/**
 * ExternalSearch represents the model behind the search form about `backend\modules\kfservice\models\External`.
 */
class ExternalSearch extends External
{
    ...
    public function rules()
    {
        return [
            ...
            [['domain_name', 'message_card', 'commodity', 'order', 'browse', 'appid'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'domain_name', $this->domain_name])
            ->andFilterWhere(['like', 'message_card', $this->message_card])
            ->andFilterWhere(['like', 'commodity', $this->commodity])
            ->andFilterWhere(['like', 'order', $this->order])
            ->andFilterWhere(['like', 'browse', $this->browse])
